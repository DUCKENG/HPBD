 const contentLetterSrart_actived = "Gửi bạn Nhi của chúng tôi x4 !" //Lời mở đầu cho bức thư
const mainContentLetter = "Nghe nói tháng 3 là một tháng đặc biệt, vừa có Quốc tế phụ nữ 8/3, vừa có Van lung tung 14/3 và đặc biệt ngày quốc tế hạnh phúc 20/3. Vì vậy nhân ngày quốc tế hạnh phúc ace Hội Trẩu xin chúc cô gái đáng yêu, dịu dàng của chúng tôi luôn luôn vui vẻ, năng động. Cuối cùng xin chúc bạn luôn vui vẻ, hạnh phúc bên gia đình, bạn bè và những người yêu thương❤️." //Nội dung của bức thư

// Gắn 1 đường link ảnh bất kì
let imgStart = document.querySelector(".myAI"); //Hình ảnh xuất hiện trong lời mở đầu của bức thư
imgStart.src = "./img/troll.jpg";

// Gắn 1 link ảnh bất kì
let imgLetter = document.querySelector(".img");
imgLetter.src = "./img/nhi.jpg"; //Hình ảnh xuất hiện trong nội dung của bức thư sau khi bức thư được viết ra hết
